...
import { ArrowLeft, CreditCard, AlertTriangle, Shield, Package, Crown, Zap } from "lucide-react";
...
function BillingPageContent() {
  ...
  const form = useForm<BillingFormData>({
    ...
    defaultValues: {
      ...
      address: (user?.billingAddress as any)?.street || '',
      city: (user?.billingAddress as any)?.city || '',
      state: (user?.billingAddress as any)?.state || '',
      zip: (user?.billingAddress as any)?.zip || '',
