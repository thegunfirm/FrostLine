                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between text-xs">
                          <div className="flex items-center gap-2">
                            <span className="text-black" style={{textShadow: '0 0 4px rgb(217 119 6), 0 0 8px rgb(217 119 6)'}}>${(parseFloat(related.priceBronze) || 0).toFixed(2)}</span>
                            <span className="text-black" style={{textShadow: '0 0 4px rgb(234 179 8), 0 0 8px rgb(234 179 8)'}}>${(parseFloat(related.priceGold) || 0).toFixed(2)}</span>
                            <span className="text-black" style={{textShadow: '0 0 4px rgb(156 163 175), 0 0 8px rgb(156 163 175)'}}>${(parseFloat(related.pricePlatinum) || 0).toFixed(2).replace(/\d/g, '*')}</span>
                          </div>
