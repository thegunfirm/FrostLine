          ...
          <div className="flex items-center ml-1">
            {ribbons.map((ribbon, index) => {
              ...
              if (ribbon.categoryName === "Uppers/Lowers") {
                buttonClass = "py-2 px-3 text-center text-white hover:text-gun-gold hover:bg-gun-black transition-all duration-200 font-bebas text-lg tracking-widest uppercase whitespace-nowrap";
                if (index < ribbons.length - 1) {
                  buttonClass += " border-r border-gun-black";
                }
                if (currentCategory === ribbon.categoryName) {
