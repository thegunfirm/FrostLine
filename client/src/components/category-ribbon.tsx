  ...
  return (
    <div className="bg-black flex flex-wrap items-end justify-center xl:justify-start gap-1 px-1 sm:px-2 py-1 max-w-full">
      {ribbons.map((ribbon, index) => {
        ...
        let buttonClass = "py-1 px-1 sm:px-2 md:py-2 md:px-3 text-center text-white hover:text-gun-gold hover:bg-gun-black transition-all duration-200 font-bebas text-base sm:text-lg md:text-xl lg:text-2xl tracking-wide uppercase whitespace-nowrap flex-shrink-0 flex items-end min-h-[2.5rem] sm:min-h-[3rem] md:min-h-[3.5rem] lg:min-h-[4rem]";
