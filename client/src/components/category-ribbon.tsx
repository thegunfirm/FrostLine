              ...
              {defaultCategories.map((item, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    currentCategory === item.category && "bg-gun-black text-gun-gold -mt-1 -mb-1 pt-3 pb-3"
                  )}
                >
                  {item.text}
                </button>
            ...
            {ribbons.map((ribbon, index) => (
              <button
                ...
                className={cn(
                  ...
                  currentCategory === ribbon.categoryName && "bg-gun-black text-gun-gold -mt-1 -mb-1 pt-3 pb-3"
                )}
              >
                {ribbon.ribbonText}
              </button>
