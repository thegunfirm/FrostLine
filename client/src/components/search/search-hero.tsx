            ...
            <div className="relative flex-1">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="w-full pl-12 py-4 text-lg border-2 border-gun-gold rounded-lg focus:outline-none focus:ring-2 focus:ring-gun-gold focus:border-transparent bg-transparent text-gun-black placeholder-gun-gray-light relative z-10"
