        ...
        <div className="relative">
          <ProductGrid 
            products={allLoadedProducts.map((hit, index) => ({
              ...
              priceWholesale: hit.tierPricing?.platinum?.dealerCasePrice?.toString() || '0',
              priceMAP: hit.tierPricing?.gold?.dealerPrice?.toString() || '0',
              priceMSRP: hit.tierPricing?.bronze?.msrp?.toString() || '0',
              priceBronze: hit.tierPricing?.bronze?.msrp?.toString() || '0',
              priceGold: hit.tierPricing?.gold?.dealerPrice?.toString() || '0',
              pricePlatinum: hit.tierPricing?.platinum?.dealerCasePrice?.toString() || '0',
